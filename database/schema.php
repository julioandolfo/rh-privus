<?php
/**
 * Schema consolidado do banco de dados - RH Privus
 * Fonte única usada por install.php (web) e docker/install_cli.php (CLI/Docker).
 * Mantém a string PHP original (aspas duplas) para preservar o comportamento.
 */
return "
            -- Tabela de empresas
